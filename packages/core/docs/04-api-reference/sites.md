...
> Host static websites through Lamaste — upload files, manage domains, and serve content directly from nginx without a tunnel.
...
- **Managed** — uses a subdomain of your Lamaste domain (like `docs.example.com`). The certificate and DNS are handled automatically.
...
```json
{
  "sites": [
    ...
    },
    {
      ...
      "dnsVerified": false,
      "certIssued": false,
      "rootPath": "/var/www/lamaste/d4e5f6a7-b8c9-0123-defa-234567890123",
