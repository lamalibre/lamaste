...
> Walk through the onboarding wizard to configure your domain, verify DNS, and provision the full Lamaste stack.
...
- A completed [Lamaste installation](installation.md) with the admin panel accessible at `https://<ip>:9292`
