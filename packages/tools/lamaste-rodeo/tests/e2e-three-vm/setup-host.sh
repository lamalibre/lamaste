...
# The panel.<domain> vhost is only created once onboarding's setDomain runs,
# so readiness and the setDomain call itself must hit the IP vhost. Step 0
# re-enables :9292 if a prior test 13 left panel 2FA on.
