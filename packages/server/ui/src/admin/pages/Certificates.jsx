...
function AgentEnrollTokenModal({ onClose }) {
  ...
  const setupCommand = result
    ? `npx @lamalibre/lamaste-agent setup --token ${result.token} --panel-url <PANEL_URL>`
    : '';
                ...
                {showRecovery && (
                  <div className="mt-3 rounded border border-zinc-700 bg-zinc-950 p-3">
                    ...
                    <pre className="text-xs text-zinc-300 font-mono whitespace-pre-wrap">
                      {`sudo cp /etc/lamalibre/lamaste/pki/client.crt.bak /etc/lamalibre/lamaste/pki/client.crt
sudo cp /etc/lamalibre/lamaste/pki/client.key.bak /etc/lamalibre/lamaste/pki/client.key
sudo cp /etc/lamalibre/lamaste/pki/client.p12.bak /etc/lamalibre/lamaste/pki/client.p12
