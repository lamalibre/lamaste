...
async function fetchScopes() {
  return apiFetch('/api/tickets/scopes');
}
...
async function fetchSessions() {
  return apiFetch('/api/tickets/sessions');
}

async function fetchAssignments() {
  return apiFetch('/api/tickets/assignments');
}

async function fetchAgents() {
  return apiFetch('/api/certs/agents');
}

async function deleteScope(name) {
  return apiFetch(`/api/tickets/scopes/${encodeURIComponent(name)}`, { method: 'DELETE' });
}

async function deleteInstance(instanceId) {
  return apiFetch(`/api/tickets/instances/${encodeURIComponent(instanceId)}`, { method: 'DELETE' });
}
...
async function deleteAssignment({ agentLabel, instanceScope }) {
  return apiFetch(`/api/tickets/assignments/${encodeURIComponent(agentLabel)}/${encodeURIComponent(instanceScope)}`, {
    method: 'DELETE',
  });
}

async function revokeTicket(ticketId) {
  return apiFetch(`/api/tickets/${encodeURIComponent(ticketId)}`, { method: 'DELETE' });
}

async function killSession(sessionId) {
  return apiFetch(`/api/tickets/sessions/${encodeURIComponent(sessionId)}`, { method: 'DELETE' });
}
